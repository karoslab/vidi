...
//  vidi
//
//  Captures push-to-talk keyboard shortcuts while Vidi is running in the
...
final class GlobalPushToTalkShortcutMonitor: ObservableObject {
    ...
    func start() {
        ...
        guard let globalEventTap = CGEvent.tapCreate(
            ...
            vlog("⚠️ Global push-to-talk: couldn't create CGEvent tap")
            return
        }
        ...
        guard let globalEventTapRunLoopSource = CFMachPortCreateRunLoopSource(
            ...
            vlog("⚠️ Global push-to-talk: couldn't create event tap run loop source")
            return
        }
